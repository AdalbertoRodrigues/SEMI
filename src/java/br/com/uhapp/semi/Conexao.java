...
public class Conexao {
    ...
    private String dataBase = "semi"; //semi_databse
    private String login = "root"; //semi_dba
    private String senha = ""; // admin1@
    ...
    public Conexao() {
        ...
        this.conexao = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/semi_database", this.login, this.senha);
        }
        catch(Exception ex) {
